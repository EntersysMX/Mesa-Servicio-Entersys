...
export const CONFIG = {
  // Smartsheet
  smartsheet: {
    apiToken: process.env.SMARTSHEET_TOKEN || 'rVcpRyiLctXXwjnmh09dEpPiZfzrodlTUdBWd',
  ...
  glpi: {
    ...
    appToken: process.env.GLPI_APP_TOKEN || 'oxhLE1abmedU2JhBRVVCb3JZw4jAZ5qd1S21dUgi',
